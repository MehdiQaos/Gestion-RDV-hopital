...
class appointment{
    ...
    public static function viewAppointment($filter,  $input = null){
        $db_connect = new db_connect;
        $pdo = $db_connect->connection();
