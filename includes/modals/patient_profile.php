<div class="modal fade" id="edit_profile_patient" >
			<div class="modal-dialog modal-sm">
				...
				?>
					...
					<input type="text" class="form-control mt-3" name="full_edit" id="full_edit"   placeholder="Full Name" value="<?= $row["full_name"]?>">
					<input type="text" class="form-control mt-3" name="email_edit" id="email_edit"   placeholder="E-mail" value="<?= $row["email"]?>">
					<input type="phone" class="form-control mt-3" name="phone_edit" id="phone_edit"   placeholder="Phone Number" value="<?= $row["phone"]?>">
					<input type="date" class="form-control mt-3" name="birth_edit" id="birth_edit"   placeholder="Birthday" value="<?= $row["birthday"]?>">
					<input type="text" class="form-control mt-3" name="cin_edit" id="cin_edit"   placeholder="CIN" value="<?= $row["cin"]?>">
			...
			<!-- end modal -->
			<div class="modal fade" id="show_profile_patient">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Profile</h1>
